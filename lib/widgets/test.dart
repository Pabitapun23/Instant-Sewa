...
class _SchedulePageState extends State<SchedulePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body:Injector(
        inject: [Inject<ServiceUserDateAndTimeModel>(()=>ServiceUserDateAndTimeModel())],
        builder: (context){
          final _serviceUserDateAndTimeModel = RM.get<ServiceUserDateAndTimeModel>();
                        ...
                        builder: (_,model){
                          return InkWell(
                            onTap: () async {
                              ...
                              _serviceUserDateAndTimeModel.setState((state) => state.setStartTime(_timeController.text));
                            },
                            child: Container(
                              width: _width / 2,
                              height: _height / 13,
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          _serviceUserDateAndTimeModel.setState((state) => state.setEndTime(_timeController2.text));
                        },
                        child: Container(
                          width: _width / 2,
                          height: _height / 13,
